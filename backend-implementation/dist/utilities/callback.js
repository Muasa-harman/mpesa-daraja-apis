...
const stkCallbackResponse = JSON.parse(fs.readFileSync('php://input', 'utf-8'));
const logFile = 'Mpesastkresponse.json';
fs.appendFileSync(logFile, JSON.stringify(stkCallbackResponse, null, 2));
const { MerchantRequestID, CheckoutRequestID, ResultCode, CallbackMetadata: { Item }, } = stkCallbackResponse.Body.stkCallback;
...
if (ResultCode === 0) {
    ...
    db.query(`INSERT INTO transactions (MerchantRequestID, CheckoutRequestID, ResultCode, Amount, MpesaReceiptNumber, PhoneNumber) 
